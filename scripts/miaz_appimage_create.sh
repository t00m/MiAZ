...
VERSION=0.0.21 DEPLOY_GTK_VERSION=4 ./linuxdeploy-x86_64.AppImage --appdir AppDir --plugin gtk --output appimage --icon-file MiAZ/data/com.github.t00m.MiAZ.svg --desktop-file MiAZ/data/com.github.t00m.MiAZ.desktop
